...
const HireMe = () => {
  return (
    <section 
      ...
      className="mb-20"
    >
      <div className="w-full border-4 border-black dark:border-white bg-cta relative overflow-hidden group">
        ...
        <div className="relative p-8 md:p-16 flex flex-col items-center justify-center text-center gap-8">
            <h2 className="text-5xl md:text-8xl font-black text-black uppercase tracking-tighter leading-[0.8] mb-4">
                NEED_SPEED?
                <br />
                <span className="opacity-60">GET_REAL.</span>
            </h2>
            ...
            <a 
                ...
                aria-label="Send email to initiate contact"
            >
                <Icon icon="mdi:flash" className="mr-4 text-cta" aria-hidden="true" />
                INITIATE_CONTACT
            </a>
