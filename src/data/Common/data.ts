...
const skills: readonly PortfolioSkill[] = [
  ...
  { id: 8, icon: "simple-icons:vercel", text: "Vercel" },
  { id: 9, icon: "simple-icons:github", text: "GitHub" },
  { id: 10, icon: "simple-icons:windsurf", text: "Windsurf" },
  { id: 11, icon: "simple-icons:openai", text: "Codex" },
  { id: 12, icon: "simple-icons:anthropic", text: "Claude" },
