...
const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Switchfolio",
    status: 'running',
    content: "A unique dual-persona portfolio website that seamlessly switches between professional and creative identities. Built with modern web technologies and advanced animations.",
  ...
  },
  {
    ...
    caseStudy: {
      ...
      solution: "Built a comprehensive content generation platform with multiple AI models, content templates, SEO analysis, and automated publishing workflows.",
  ...
  },
  {
    ...
    url: "",
    github: "",
    skill: ["Salesforce", "Apex", "Lightning Web Components", "Node.js", "REST APIs", "Tableau"],
    caseStudy: {
