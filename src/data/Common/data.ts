...
const projects: Project[] = [
  {
    ...
    title: "Bold Choice",
    status: 'building',
    content: "Tech startup building autonomous robotics for industrial automation. Currently in development phase.",
    url: "",
    github: "",
  ...
  },
  {
    ...
    title: "Switchfolio",
    status: 'running',
    content: "A dual-persona portfolio website that seamlessly switches between professional and creative identities.",
  ...
  },
  {
    ...
    url: "",
    github: "",
    skill: ["Salesforce", "Apex", "Lightning Web Components", "Integration", "APIs", "Data Synchronization", "Tableau"],
    caseStudy: {
